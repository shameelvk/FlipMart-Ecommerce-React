...
const OfferList = () => {
  ...
  return (
    <div className="container-fluid offer-container " style={{boxShadow:"box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px;"}}>
            ...
            <div className="row row-cols-1 row-cols-md-4 g-4">
                    ...
                    {offerProducts.map((offpd)=><div className="col-12 col-md-3">

                    <OfferCard offerData={offpd} key={offpd.id}/>
                    </div>
                    )}
            </div>
        </div>
